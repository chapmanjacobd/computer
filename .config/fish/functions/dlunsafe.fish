...
function dlunsafe
    maxmem10b lbdl ~/lb/dl/tax_sounds.db --audio --prefix /mnt/d/dump/porn/audio/ $argv
    maxmem10b lbdl ~/lb/dl/audio.db --audio --prefix /mnt/d/dump/audio/ $argv
    wait
    maxmem10b lbdl ~/lb/dl/video.db --video --small --prefix /mnt/d/dump/video/other/ $argv
    wait
