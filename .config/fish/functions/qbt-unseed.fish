function qbt-unseed
    set processing_dir processing/(datestamp)
    allpc library torrents --complete --seeders=+4 --time-stalled=+3days --time-seeding=+61days --stop --move $processing_dir --delete-rows -v
    # stop incomplete
    allpc library torrents --incomplete --time-active=+61days --time-unseeded=+90days --delete-incomplete --stop --move $processing_dir-incomplete --tag library-delete -v
