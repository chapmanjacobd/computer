function dbackups
    ...
    for folder in 69_Taxes_Keep 68_Vr_Tv_Keep
        rsync -ah --info=progress2 --no-inc-recursive /mnt/d/$folder/*.small.* backup:/mnt/d/$folder/
    end
