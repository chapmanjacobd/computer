...
function sync_history
    ...
    # count ~/.local/share/z/data.sync-conflict* >/dev/null; and cat ~/.local/share/z/data.sync-conflict* >>~/.local/share/z/data; and trash-put ~/.local/share/z/data.sync-conflict*
end
