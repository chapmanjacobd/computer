function forganize
    ...
    refreshLibrary
    lb wt --keep-dir /mnt/d/70_Now_Watching/Keep/ ~/lb/fs/tax.db -l inf --local-media-only -d-0.8 -pf | xargs -P 20 -I{} rm {}
    lb wt --keep-dir /mnt/d/70_Now_Watching/Keep/ ~/lb/fs/tax.db -l inf --local-media-only -d-0.8 -pfd
