...
function mam_db_dl --argument db
    ...
    sqlite --no-headers --raw-lines "$db" "update media set my_snatched=1 where seeders>0 and my_snatched=0 and unixepoch(added) > $(timestamp 1 week ago 0 -u)"
end
