function qbt.unseed.old
    ...
    # stop incomplete
    allpc library torrents --incomplete --time-active=+65days --time-unseeded=+90days --delete-incomplete --stop --move processing-incomplete --tag library-delete -v
    allpc library torrents --incomplete --time-active=+65days --inactive --downloaded=0 --stop --tag library-no-seed -v
end
