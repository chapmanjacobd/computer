function qbt.unseed.old
    ...
    servers.ssh lb torrents --time-completed=+48h --complete --no-private --stop --move processing --delete-rows
    ...
    servers.ssh lb torrents --incomplete --progress=-2.5% --time-downloading=+20days --time-stalled=+20days --stop --delete-incomplete --move processing-incomplete --delete-rows -v
    servers.ssh lb torrents --incomplete --no-private --time-downloading=+20days --time-stalled=+20days --stop --delete-incomplete --move processing-incomplete --delete-rows -v
end
