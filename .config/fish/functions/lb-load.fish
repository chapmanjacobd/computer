...
function lb-load
    ...
    lb mv --ext jpg,jpeg,png,pdf,tiff,tif,bmp,webp ~/d/dump/porn/video/ /mnt/d/dump/porn/image/from_video/
    lb mv --ext mka,m4a,mp3 ~/d/dump/porn/video/ /mnt/d/dump/porn/audio/from_video/
    ~/d/dump/porn/video/
