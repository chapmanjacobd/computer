...
function relax
    ...
    feh -q -F --hide-pointer --sort filename --on-last-slide resume --action2 "mv '%f' ./keep/" --action1 "/home/xk/.local/bin/trash-put '%f'" --action3 "mv '%f' ../95_Memes/" --action4 "mv '%f' ../96_Weird_History/" --action5 "mv '%f' ../52_Receipts/" --action7 "mv '%f' ../94_Cool/" --action8 "mv '%f' ../93_BG/" --action6 "mv '%f' ../98_Me/" --action "/home/xk/.local/bin/trash-put '%f'" -G --auto-zoom --zoom max --draw-tinted --image-bg black --scale-down -D -3 .
    pkill mpv
end
