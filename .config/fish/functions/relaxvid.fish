...
function relaxvid
    ...
    lb-dev wt ~/lb/fs/tax.db -L inf --action ask_move_or_delete --keep-dir /home/xk/d/60_Now_Watching/keep/ -m 2 $argv --sort "path like '%64_Relaxation%' desc, time_modified, duration desc, priority"
    pkill -x mpv
end
