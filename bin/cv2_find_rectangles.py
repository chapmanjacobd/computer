...
def main():
    parser = argparse.ArgumentParser(description='Detect and crop rectangles from an image.')
    parser.add_argument('input_image', type=str, help='Path to the input image')
    parser.add_argument('-o', '--output_folder', type=str, default='output/', help='Output folder to save cropped rectangles')
