...
sudo apt install pipx python-is-python3 eza libguestfs-tools qemu-guest-agent bfs wget2 tmux earlyoom zoxide cargo kitty git-delta progress ncdu fzf fish cmake
